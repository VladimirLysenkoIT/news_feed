...
if (document.getElementById("news_wrapp")) {
	function showNews(news) {
		...
		for (var i = 0; i < news.length; i++) {
			...
			*/
			...
			news_delete_button.innerHTML = "Delete";
			...
			news_category.innerHTML = "Category: " + news[i]["category"];
			...
			news_source.innerHTML = "Source:  <a href='http://"+news[i]['source']+"'>"+news[i]["source"]+"</a>";
		}
	}
}